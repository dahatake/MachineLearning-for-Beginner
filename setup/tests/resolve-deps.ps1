...
try {
    ...
    $pipTargets = @(
        ...
        @{ Platform = "manylinux_2_28_aarch64"; PythonVersion = "314"; Abi = "cp314"; BasePackages = @("scikit-learn==1.8.0", "matplotlib==3.10.7", "notebook==7.6.3", "nbconvert==7.16.6", "ipykernel==6.30.1", "numpy==2.3.2"); TorchPackages = @("torch==2.9.1", "torchvision==0.24.1"); TorchPlatform = "manylinux_2_28_aarch64" }
    )
